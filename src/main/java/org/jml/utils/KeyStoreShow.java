...
public class KeyStoreShow {
	public static void main(String[] args) throws IOException, GeneralSecurityException {
		...
		storeType = "jks";
		keyStoreFile = "/Users/jeremiahlumontod/Desktop/folders/projs/refs/ca/clientcert/jmlclient.jks";
		showPubKey = true;
		...
		while (aliases.hasMoreElements()) {
			...
			if (cert != null) {
				if ("X.509".equals(cert.getType())) {
					...
					String key = new String(x509.getEncoded().toString());
					System.out.println("key:\n" + key);
					
					key = new String(Base64.encodeBase64(cert.getEncoded()));
					System.out.println("key:\n" + key);
